	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(submitType.equals("addbook")) {
			...
			*/
			...
			String text;
			if (request.getParameter("TargetInventoryID").length()>0) {
				...
				if (book.getTitle()==null) {
					...
					text = book.editAll(request.getParameter("TargetISBN"), 
							request.getParameter("title"), request.getParameter("author"), request.getParameter("category"),
							request.getParameter("edition"), request.getParameter("Status"));
				}
			}
			else {
