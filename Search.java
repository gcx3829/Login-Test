...
public class Search {
	public String search(Book b, int usertype) {
		...
		if (usertype == 0) {
			displayTable.append("<tr><th>ISBN</th><th>Title</th><th>Author</th><th>Category</th><th>Edition</th><th>Status</th><th>CopyId</th></tr>"); //set up first line of table
		}else {
			displayTable.append("<tr><th>ISBN</th><th>Title</th><th>Author</th><th>Category</th><th>Edition</th><th>Status</th><th>CopyId</th><th>RentedBy</th><th>CheckOutDate</th><th>ReturnByDate</th></tr>");
		}
