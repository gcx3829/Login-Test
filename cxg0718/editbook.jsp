...
<form name="regform" action="ManageController" method="post">
	...
	<!-- Remove the target ISBN and target copyID  using inventoryID  -->
	
	<h3>Note: when you edit title info(Title, Author, Genre, Edition), all books with same ISBN will be changed at the same time!</h3>
	<h3>Note: be careful when editing copy info(RentedBy, CheckOutDate, ReturnByDate), it may cause error with waitlist function</h3>
